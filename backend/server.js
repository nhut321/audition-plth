...
import setupChatNamespace from "./namespaces/chatNamespace.js";
import setupUpdateNamespace from "./namespaces/updateNamespace.js";
import connectDB from "./db.js";
import dotenv from 'dotenv';
import cors from 'cors'

dotenv.config(); // Đảm bảo tệp .env được tải
...
const createServer = () => {
    ...
    setupUpdateNamespace(io);

    return { server, port: process.env.PORT || 3000 };
};
